            ...
            <div class="container">
                <div class="main-header-row">
                    ...
                    <div class="flex items-center gap-4 flex-shrink-0">
                        ...
                        <a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" class="flex gap-2  items-center text-gray-600 hover:text-vibrant-orange cursor-pointer transition-colors">
